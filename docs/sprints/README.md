...
| [22](sprint-22-notes.md) | The release — v1.0.0: the machinery, the environment layer, the self-hosting showcase | [#24](https://github.com/leocamello/parley/issues/24) | `af53fa0` | 1140 |
