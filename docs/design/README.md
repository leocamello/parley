...
| **C** | [`resolver.md`](resolver.md) | The pure resolver, `ConstraintLedger` provenance, `BacktrackingStrategy`, conflict narration, the `PackageSource` protocol (§1.2 `seededWith:`), and the **snapshot contract** — §2.1 retirement filtering and §2.2 held-pin narrowing, both of which the resolver never learns about | Sprint 2 |
