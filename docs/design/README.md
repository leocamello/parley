...
| **E** | [`execution-and-cli.md`](execution-and-cli.md) | `ProcessRunner`, `ExecutionScope` (the curated child `gst`), `ManifestFile`, `CLI`, `CommandLine` and the diagnosis boundary, the shipped binary | Sprint 6 |
