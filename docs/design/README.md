...
| **E** | [`execution-and-cli.md`](execution-and-cli.md) | `ProcessRunner`, `ExecutionScope` (the curated child `gst`), `ManifestFile`, `CLI` | Sprint 6 |
| **F** | [`publish-and-sources.md`](publish-and-sources.md) | The publish pipeline, the composed `package.xml`, schema-shape validation, `GitIndexSource` | Sprint 7 |
